...
def main():
    parser = argparse.ArgumentParser(description="Run multi-turn attack experiments on various victim models.")
    parser.add_argument("--victim_model", type=str, required=True, help="Victim model name (e.g., 'meta-llama/Meta-Llama-3-8B-Instruct')")
    parser.add_argument("--victim_name", type=str, required=True, help="Short name for victim model (e.g., 'llama3_8b')")
